    ...
    <div class="project-modal-content">
        ...
        <template v-for="block in blocks">
            <div v-if="block.visibility" class="project-modal-content-block">
                ...
                <template v-if="Array.isArray(block.description)">
                    <p v-for="paragraph in block.description"
                       class="text-3 mb-2 project-modal-content-paragraph"
                       v-html="paragraph"/>
                </template>
                <p v-else class="text-3 mb-0" v-html="block.description"/>
...
div.project-modal-content-block {
    ...
    p.project-modal-content-paragraph:last-of-type {
